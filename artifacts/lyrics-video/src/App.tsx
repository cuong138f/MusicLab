...
const DEFAULT_PROMPT = `You are an audio transcription tool. Listen to this ENTIRE audio file from start to finish and output every lyric line with its precise timestamp.
